...
export const newsItems: NewsItem[] = [
  {
    ...
    date: "2026-05-27",
    title: "Los fichajes invernales del Avilés se despiden del club",
  ...
  },
  {
    ...
    source: "La Nueva España",
    date: "2026-05-27",
    title: "Los fichajes veraniegos del Avilés con renovación automática",
    excerpt: "Varios futbolistas incorporados en verano tienen cláusulas de prórroga que condicionan la planificación del verano.",
  ...
  },
  {
    ...
    source: "La Nueva España",
    date: "2026-05-27",
    title: "Habla el arquitecto de la salvación del Avilés: «¿Hemos…?»",
    excerpt: "Entrevista con una de las piezas clave del proyecto que llevó al equipo a salvar la categoría en Primera Federación.",
  ...
  },
  {
    ...
    source: "La Nueva España",
    date: "2026-05-26",
    title: "El día de las oposiciones, minuto a minuto",
    excerpt: "Seguimiento en directo del partido decisivo por la permanencia en Primera Federación.",
  ...
  },
  {
    ...
    source: "La Nueva España",
    date: "2026-05-26",
    title: "El Avilés, ante una profunda reconstrucción: situación de contratos",
    excerpt: "Panorama contractual y deportivo del club tras certificar la permanencia en la categoría de bronce.",
  ...
  },
  {
    ...
    excerpt: "El entrenador define prioridades y mensaje de cara al verano y a la nueva etapa del Real Avilés Industrial.",
  ...
  },
  {
    ...
    source: "El Comercio",
    date: "2026-05-26",
    title: "El presidente del Real Avilés pasa revista con la voz de Linares",
    excerpt: "Balance de temporada y primeras líneas del futuro inmediato del club desde la presidencia.",
  ...
  },
  {
    ...
    source: "El Comercio",
    date: "2026-05-25",
    title: "Una temporada sufrida con final feliz para el Real Avilés",
    excerpt: "Repaso a un curso convulso que terminó con la salvación en el tramo final de la competición.",
  ...
  },
  {
    ...
    source: "El Comercio",
    date: "2026-05-24",
    title: "El Real Avilés tiene un verano de trabajo entre plantilla y entrenador",
    excerpt: "El club afronta un periodo de definiciones en el banquillo y en la composición de la plantilla.",
  ...
  },
  {
    ...
    excerpt: "El equipo certifica la permanencia y seguirá compitiendo en la tercera categoría del fútbol español.",
  ...
  },
  {
    ...
    excerpt: "Previa del duelo en Pontevedra con el ascenso a Segunda como telón de fondo y la salvación en juego.",
  ...
  },
  {
    ...
    excerpt: "El club valora la renovación del entrenador tras el éxito en la permanencia.",
