...
const baseTeams: Team[] = [
  ...
  { id: "tenerife", name: "CD Tenerife", shortName: "Tenerife", city: "Santa Cruz de Tenerife", stadium: "Heliodoro Rodriguez Lopez", coach: "Luis Carrion", founded: 1922, crestInitials: "TEN", colors: ["#1D4ED8", "#FFFFFF"], position: 0, form: [], stats: { played: 0, won: 0, drawn: 0, lost: 0, goalsFor: 0, goalsAgainst: 0, points: 0 } },
  ...
  { id: "celta-fortuna", name: "Celta de Vigo B", shortName: "Celta B", city: "Vigo", stadium: "Municipal de Barreiro", coach: "TBD", founded: 1927, crestInitials: "CEL", colors: ["#0EA5E9", "#FFFFFF"], position: 0, form: [], stats: { played: 0, won: 0, drawn: 0, lost: 0, goalsFor: 0, goalsAgainst: 0, points: 0 } },
