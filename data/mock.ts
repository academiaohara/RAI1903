...
import { FILIAL_AVILES_B_COACH, filialAvilesBSquad } from "@/data/filial-real-aviles-b-squad";
...
const femeninoStats = { appearances: 0, goals: 0, assists: 0, minutes: 0, yellowCards: 0, redCards: 0 };
const femeninoClub = "Real Avilés Industrial Femenino";

export const playersFemenino: Player[] = [
  { id: "fem-paula-madrazo", firstName: "Paula", lastName: "Madrazo Nogueiro", displayName: "Paula", number: 1, position: "Portero", nationality: "España", birthPlace: "Gijon", age: 22, birthDate: "2004-03-15", height: "1,73 m", preferredFoot: "Derecha", seasonsAtClub: 2, status: "titular", rating: 7.1, bio: "Portera de referencia, segura bajo palos y con buena salida de balon.", clubHistory: [femeninoClub], stats: femeninoStats },
  { id: "fem-elena-casao", firstName: "Elena", lastName: "Casao Lopez", displayName: "Elena", number: 13, position: "Portero", nationality: "España", birthPlace: "La Almunia", age: 24, birthDate: "2002-05-20", height: "1,71 m", preferredFoot: "Derecha", seasonsAtClub: 1, status: "suplente", rating: 6.95, bio: "Portera suplente con experiencia y buen juego aereo.", clubHistory: [femeninoClub], stats: femeninoStats },
  { id: "fem-andrea-fernandez", firstName: "Andrea", lastName: "Fernandez Vergel", displayName: "Andrea", number: 2, position: "Defensa", nationality: "España", birthPlace: "Aviles", age: 16, birthDate: "2010-08-10", height: "1,66 m", preferredFoot: "Derecha", seasonsAtClub: 4, status: "cantera", rating: 6.7, bio: "Defensa joven de la cantera con proyeccion y buen juego de pies.", clubHistory: ["Real Aviles Cadete Femenino", femeninoClub], stats: femeninoStats },
  { id: "fem-goretti-neira", firstName: "Goretti", lastName: "Neira Lopez", displayName: "Goretti", number: 4, position: "Defensa", nationality: "España", birthPlace: "A Coruna", age: 25, birthDate: "2001-02-14", height: "1,70 m", preferredFoot: "Derecha", seasonsAtClub: 1, status: "titular", rating: 7.05, bio: "Defensa central solida en marca y juego aereo.", clubHistory: [femeninoClub], stats: femeninoStats },
  { id: "fem-elizabet-rodriguez", firstName: "Elizabet", lastName: "Rodriguez Rodriguez", displayName: "Eli", number: 5, position: "Defensa", nationality: "España", birthPlace: "Aviles", age: 30, birthDate: "1996-11-08", height: "1,69 m", preferredFoot: "Izquierda", seasonsAtClub: 3, status: "titular", rating: 7.12, bio: "Defensa veterana, lider del eje y referente en el vestuario.", clubHistory: [femeninoClub], stats: femeninoStats },
  { id: "fem-lucia-ayuso", firstName: "Lucia", lastName: "Ayuso Fuentes", displayName: "Ayuso", number: 14, position: "Defensa", nationality: "España", birthPlace: "Aviles", age: 23, birthDate: "2003-04-22", height: "1,68 m", preferredFoot: "Derecha", seasonsAtClub: 2, status: "titular", rating: 7.0, bio: "Defensa polivalente con buena salida y lectura del juego.", clubHistory: [femeninoClub], stats: femeninoStats },
  { id: "fem-mirdja-rodriguez", firstName: "Mirdja", lastName: "Rodriguez Iglesias", displayName: "Mirdja", number: 16, position: "Defensa", nationality: "España", birthPlace: "Oviedo", age: 21, birthDate: "2005-07-30", height: "1,67 m", preferredFoot: "Izquierda", seasonsAtClub: 2, status: "titular", rating: 6.98, bio: "Defensa rapida con buen desplazamiento y anticipacion.", clubHistory: [femeninoClub], stats: femeninoStats },
  { id: "fem-tayre-fernandez", firstName: "Tay", lastName: "Fernandez Vega", displayName: "Tay", number: 18, position: "Defensa", nationality: "España", birthPlace: "Corvera", age: 22, birthDate: "2004-01-18", height: "1,70 m", preferredFoot: "Derecha", seasonsAtClub: 1, status: "suplente", rating: 6.92, bio: "Defensa con buen fisico y capacidad para sumar en ataque.", clubHistory: [femeninoClub], stats: femeninoStats },
  { id: "fem-maria-iglesias", firstName: "Maria", lastName: "Iglesias Orviz", displayName: "Iglesias", number: 22, position: "Defensa", nationality: "España", birthPlace: "Gijon", age: 30, birthDate: "1996-06-05", height: "1,71 m", preferredFoot: "Derecha", seasonsAtClub: 2, status: "titular", rating: 7.08, bio: "Defensa experimentada, fuerte en duelos y organizacion.", clubHistory: [femeninoClub], stats: femeninoStats },
  { id: "fem-laura-lobo", firstName: "Laura Lobo", lastName: "Paredes", displayName: "Laura Lobo", number: 6, position: "Centrocampista", nationality: "España", birthPlace: "Barcelona", age: 21, birthDate: "2005-09-12", height: "1,65 m", preferredFoot: "Derecha", seasonsAtClub: 1, status: "titular", rating: 7.15, bio: "Centrocampista con vision, pase entre lineas y llegada al area.", clubHistory: [femeninoClub], stats: femeninoStats },
  { id: "fem-carmen-penalver", firstName: "Carmen", lastName: "Penalver Pelaez", displayName: "Coche", number: 7, position: "Centrocampista", nationality: "España", birthPlace: "Aviles", age: 28, birthDate: "1998-03-25", height: "1,66 m", preferredFoot: "Derecha", seasonsAtClub: 4, status: "titular", rating: 7.25, bio: "Mediocampista de control, volumen de juego y liderazgo en el centro del campo.", clubHistory: [femeninoClub], stats: femeninoStats },
  { id: "fem-paula-martinez", firstName: "Paula", lastName: "Martinez Gonzalez", displayName: "Pali", number: 8, position: "Centrocampista", nationality: "España", birthPlace: "Corvera", age: 22, birthDate: "2004-10-02", height: "1,64 m", preferredFoot: "Izquierda", seasonsAtClub: 2, status: "titular", rating: 7.05, bio: "Centrocampista dinamica, buena presion y recuperacion de balon.", clubHistory: [femeninoClub], stats: femeninoStats },
  { id: "fem-laura-tomas", firstName: "Laura", lastName: "Tomas Navarro", displayName: "Laura", number: 17, position: "Centrocampista", nationality: "España", birthPlace: "Tortosa", age: 30, birthDate: "1996-12-01", height: "1,67 m", preferredFoot: "Derecha", seasonsAtClub: 1, status: "titular", rating: 7.1, bio: "Centrocampista veterana con experiencia y criterio en fases decisivas.", clubHistory: [femeninoClub], stats: femeninoStats },
  { id: "fem-sara-randez", firstName: "Sara", lastName: "Randez Navajas", displayName: "Sara", number: 19, position: "Centrocampista", nationality: "España", birthPlace: "Alfaro", age: 26, birthDate: "2000-04-17", height: "1,66 m", preferredFoot: "Derecha", seasonsAtClub: 1, status: "suplente", rating: 6.95, bio: "Centrocampista con buen golpeo y capacidad para activar el ataque.", clubHistory: [femeninoClub], stats: femeninoStats },
  { id: "fem-nuria-torres", firstName: "Nuria", lastName: "Torres Rosal", displayName: "Nuria", number: 20, position: "Centrocampista", nationality: "España", birthPlace: "Portonovo", age: 23, birthDate: "2003-08-28", height: "1,65 m", preferredFoot: "Izquierda", seasonsAtClub: 1, status: "suplente", rating: 6.9, bio: "Centrocampista con desborde y buen ultimo pase.", clubHistory: [femeninoClub], stats: femeninoStats },
  { id: "fem-tatiana-rodriguez", firstName: "Tatiana", lastName: "Rodriguez del Valle", displayName: "Tati", number: 21, position: "Centrocampista", nationality: "Francia", birthPlace: "Paris", age: 24, birthDate: "2002-01-09", height: "1,68 m", preferredFoot: "Derecha", seasonsAtClub: 1, status: "titular", rating: 7.12, bio: "Centrocampista con calidad tecnica y capacidad para romper lineas.", clubHistory: [femeninoClub], stats: femeninoStats },
  { id: "fem-elena-pradilla", firstName: "Elena", lastName: "Pradilla Aranda", displayName: "E. Pradilla", number: 23, position: "Centrocampista", nationality: "España", birthPlace: "Jaca", age: 28, birthDate: "1998-07-14", height: "1,66 m", preferredFoot: "Derecha", seasonsAtClub: 1, status: "suplente", rating: 6.93, bio: "Centrocampista de contencion, orden y recuperacion.", clubHistory: [femeninoClub], stats: femeninoStats },
  { id: "fem-cristina-menendez", firstName: "Cristina", lastName: "Menendez Gonzalez", displayName: "Cris", number: 3, position: "Delantero", nationality: "España", birthPlace: "Gijon", age: 21, birthDate: "2005-02-20", height: "1,70 m", preferredFoot: "Derecha", seasonsAtClub: 2, status: "titular", rating: 7.2, bio: "Delantera con movimiento, definicion y buen juego de espaldas.", clubHistory: [femeninoClub], stats: femeninoStats },
  { id: "fem-noa-diaz", firstName: "Noa", lastName: "Diaz Rodriguez", displayName: "Noa", number: 9, position: "Delantero", nationality: "España", age: 18, birthDate: "2008-05-11", height: "1,67 m", preferredFoot: "Izquierda", seasonsAtClub: 5, status: "cantera", rating: 6.85, bio: "Delantera joven con velocidad y descaro en el ultimo tercio.", clubHistory: ["Real Aviles Cadete Femenino", femeninoClub], stats: femeninoStats },
  { id: "fem-marina-monteserin", firstName: "Marina Monte", lastName: "Monteserin Lopez", displayName: "Marina Monte", number: 10, position: "Delantero", nationality: "España", birthPlace: "Aviles", age: 23, birthDate: "2003-06-16", height: "1,69 m", preferredFoot: "Derecha", seasonsAtClub: 2, status: "titular", rating: 7.18, bio: "Delantera goleadora con buen juego aereo y presencia en area.", clubHistory: [femeninoClub], stats: femeninoStats },
  { id: "fem-amaya-coleman", firstName: "Amaya", lastName: "Coleman Evans", displayName: "Amaya", number: 11, position: "Delantero", nationality: "Estados Unidos", age: 22, birthDate: "2004-11-23", height: "1,72 m", preferredFoot: "Derecha", seasonsAtClub: 1, status: "titular", rating: 7.1, bio: "Delantera potente, buen uno contra uno y finalizacion.", clubHistory: [femeninoClub], stats: femeninoStats },
  { id: "fem-daniela-gonzalez", firstName: "Daniela", lastName: "Gonzalez Lallende", displayName: "Daniela", number: 12, position: "Delantero", nationality: "España", birthPlace: "Oviedo", age: 22, birthDate: "2004-04-07", height: "1,68 m", preferredFoot: "Izquierda", seasonsAtClub: 1, status: "suplente", rating: 6.95, bio: "Delantera con desborde por banda y llegada al segundo palo.", clubHistory: [femeninoClub], stats: femeninoStats },
  { id: "fem-paula-carballo", firstName: "Paula Carballo", lastName: "Riesgo", displayName: "Paula Carballo", number: 15, position: "Delantero", nationality: "España", birthPlace: "Oviedo", age: 24, birthDate: "2002-09-19", height: "1,70 m", preferredFoot: "Derecha", seasonsAtClub: 1, status: "titular", rating: 7.05, bio: "Delantera con buen movimiento sin balon y capacidad asociativa.", clubHistory: [femeninoClub], stats: femeninoStats },
  { id: "fem-sarina-heeb", firstName: "Sarina", lastName: "Heeb", displayName: "Sarina", number: 24, position: "Delantero", nationality: "Suiza", birthPlace: "Frauenfeld", age: 22, birthDate: "2004-12-30", height: "1,71 m", preferredFoot: "Derecha", seasonsAtClub: 1, status: "suplente", rating: 7.0, bio: "Delantera internacional con calidad tecnica y definicion.", clubHistory: [femeninoClub], stats: femeninoStats },
];
    ...
    roster: [
      {
        id: "mario-noval",
        displayName: "M. Noval",
        fullName: "Mario Noval",
        number: 7,
        position: "Delantero",
        role: "Delantero",
        age: 17,
        stats: { convocados: 0, partidos: 0, titular: 0, minutos: 0, goles: 0, amarillas: 0, rojas: 0 },
      },
      {
        id: "leo-paredes",
        displayName: "L. Paredes",
        fullName: "Leo Paredes",
        number: 10,
        position: "Centrocampista",
        role: "Centrocampista",
        age: 18,
      ...
      {
        id: "dani-riestra",
        displayName: "D. Riestra",
        fullName: "Dani Riestra",
        number: 1,
        position: "Portero",
        role: "Portero",
        age: 18,
      ...
      {
        id: "hugo-menendez",
        displayName: "H. Menendez",
        fullName: "Hugo Menéndez",
        number: 9,
        position: "Delantero",
        role: "Delantero",
        age: 17,
