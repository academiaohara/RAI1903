...
export function PlayerCard({
  ...
  if (canQuickEdit) {
    return (
      ...
      >
        <article className="relative overflow-hidden rounded-[1.75rem] border-2 border-dashed border-[#214C9B]/35 bg-gradient-to-b from-white via-slate-50 to-blue-50/40 shadow-[0_18px_45px_rgba(17,24,39,0.08)]">
          <button
            type="button"
          ...
          >
            ...
            <div className="relative mt-4">
              ...
              <h3 className="mt-1 text-lg font-extrabold uppercase leading-tight text-slate-900">
          ...
          <SquadPlayerQuickEdit
            ...
            layout="card"
          />
          <div className="border-t border-[#214C9B]/10 px-3 py-2">
            <button
              type="button"
              onClick={() => onSelect(player)}
              className="w-full text-center text-[10px] font-extrabold uppercase tracking-wide text-[#214C9B] hover:underline"
            >
              Ficha completa
            </button>
          </div>
