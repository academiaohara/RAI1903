...
const toneByKind = {
  fichaje: {
    hero: "from-[#5a1210] via-[#981915] to-[#c42822]",
            ...
            {activeTab === "actualidad" && (
              <div className="space-y-8">
                ...
                <section className="space-y-3">
                  <div className="flex items-center gap-2">
                    <Megaphone className={tone.accent} size={18} aria-hidden />
                    <h2 className="text-sm font-extrabold uppercase tracking-wide text-slate-900">Prensa</h2>
                  </div>
                  {pressNews.length > 0 ? (
                    <div className="space-y-3">
                      {pressNews.map((item) => (
                    ...
                    <p className="text-sm text-slate-500">Sin titulares de prensa vinculados en el mock.</p>
                  )}
                </section>
