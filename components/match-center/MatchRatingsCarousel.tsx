...
export function MatchRatingsCarousel({
  ...
  return (
    <div className="space-y-4">
      <p className="text-center text-sm font-extrabold uppercase tracking-wide text-slate-700">
      ...
      <div className="relative flex items-center justify-center gap-4 sm:gap-8">
        ...
        <div className="relative mx-auto aspect-[3/4] w-[min(44vw,11rem)] overflow-hidden rounded-2xl border-2 border-[#981915]/30 bg-gradient-to-b from-slate-100 to-white shadow-lg sm:w-44">
          <PlayerAvatar
        ...
        <div className="flex flex-col items-center gap-2">
          <button
            ...
            className="flex h-12 w-12 items-center justify-center rounded-full bg-[#981915] text-white shadow-md transition hover:bg-[#7f1411] disabled:opacity-40"
          ...
          <div className="text-center">
            <p className="text-5xl font-black tabular-nums leading-none text-[#981915]">
          ...
          {community ? (
            <div className="mt-2 rounded-xl border border-[#214C9B]/15 bg-slate-50 px-3 py-2 text-center">
              <p className="text-[10px] font-bold uppercase text-slate-500">Comunidad</p>
              <p className="text-lg font-extrabold tabular-nums text-[#214C9B]">
