                  ...
                  <li key={item.href}>
                    ...
                    >
                      <Icon
                        size={20}
                        strokeWidth={2.25}
                        className={cn("shrink-0 self-center", active ? "text-[#214C9B]" : "text-white")}
                        aria-hidden
                      />
                      <span className={cn("min-w-0 flex-1 self-center", active && "text-[#214C9B]")}>{item.label}</span>
                      <ChevronRight
                        size={18}
                        strokeWidth={2.25}
                        className={cn("shrink-0", active ? "text-[#214C9B]/55" : "text-white/45")}
                        aria-hidden
                      />
                    </Link>
                  </li>
