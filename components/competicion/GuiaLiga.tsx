...
function clubTeamId(gender: PrimerEquipoGender): string {
          ...
          {displayTeams.map((team) => {
            ...
            return (
              <Link
                ...
                aria-label={
                  team.id === clubTeamId(gender)
                    ? `Ver plantilla de ${team.name}`
                    : `Ver ficha de ${team.name}`
                }
                title={team.name}
              >
                {crest}
