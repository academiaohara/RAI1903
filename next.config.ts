...
const nextConfig: NextConfig = {
  ...
  async redirects() {
    return [
      ...
      { source: "/primer-equipo/masculino/cronicas/:articleId", destination: "/primer-equipo/masculino/plantilla", permanent: false },
      ...
      { source: "/primer-equipo/masculino/previas/:articleId", destination: "/primer-equipo/masculino/plantilla", permanent: false },
