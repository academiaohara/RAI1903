...
const nextConfig: NextConfig = {
  ...
  async redirects() {
    return [
      ...
      { source: "/primer-equipo/previas", destination: "/primer-equipo/masculino/cronicas", permanent: false },
      { source: "/primer-equipo/masculino/previas", destination: "/primer-equipo/masculino/cronicas", permanent: false },
      ...
      { source: "/primer-equipo/masculino/previas/:articleId", destination: "/primer-equipo/masculino/cronicas/:articleId", permanent: true },
      { source: "/primer-equipo/masculino/cronicas/previa-:matchId", destination: "/primer-equipo/masculino/cronicas/cronica-:matchId", permanent: true },
