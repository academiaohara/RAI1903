...
const nextConfig: NextConfig = {
  ...
  async redirects() {
    return [
      ...
      { source: "/primer-equipo/femenino/previas", destination: "/primer-equipo/femenino/cronicas", permanent: false },
      { source: "/primer-equipo/masculino/previas/:articleId", destination: "/primer-equipo/masculino/cronicas/:articleId", permanent: false },
      { source: "/primer-equipo/femenino/previas/:articleId", destination: "/primer-equipo/femenino/cronicas/:articleId", permanent: false },
